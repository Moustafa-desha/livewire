                    ...
                    <form wire:submit.prevent="update" enctype="multipart/form-data">
                        ...
                        @if($this->image_original !== '')
                            <div class="form-group my-2">
                                <img src="{{ asset('assets/images/'.$this->image_original) }}" alt="{{$this->title}}" width="100px">
                            </div>
                        @endif
                        <div class="form-group">
                            <label for="image"> Image </label>
                            <input type="file" value="{{$post->image}}" name="image" class="form-control" wire:model="image" >
